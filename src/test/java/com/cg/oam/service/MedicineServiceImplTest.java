...
class MedicineServiceImplTest {
	...
	void testFindById() {
		Medicine testdata = new Medicine("M01","paracetmol",56,LocalDate.parse("2021-03-22"),LocalDate.parse("2022-09-09"),12,Company.Divis,null);
		MedicineModel expected = new MedicineModel("M01","paracetmol",56,LocalDate.parse("2021-03-22"),LocalDate.parse("2022-09-09"),12,"Divis",null);
	...
	void testFindByIdNotExists() {
		...
		Medicine testdata = new Medicine("M01","paracetmol",56,LocalDate.parse("2021-03-22"),LocalDate.parse("2022-09-09"),11,Company.Divis,null);
		MedicineModel expected = new MedicineModel("M01","paracetmol",56,LocalDate.parse("2021-03-22"),LocalDate.parse("2022-09-09"),11,"Divis",null);
	...
	void testFindAll() {
		List<Medicine> testdata = Arrays.asList(new Medicine[] {
				new Medicine("M01","paracetmol",56,LocalDate.parse("2021-03-22"),LocalDate.parse("2022-09-09"),12,Company.Divis,null),
				new Medicine("M02","paracetmol",56,LocalDate.parse("2021-03-22"),LocalDate.parse("2022-09-09"),12,Company.Divis,null)
		...
		new MedicineModel("M01","paracetmol",56,LocalDate.parse("2021-03-22"),LocalDate.parse("2022-09-09"),2,"Divis",null)
		});
	...
	void testFindAll1() {
		List<Medicine> testdata = Arrays.asList(new Medicine[] {
				...
				List<MedicineModel> expected = Arrays.asList(new MedicineModel[] {
						new MedicineModel("M01","paracetmol",56,LocalDate.parse("2021-03-22"),LocalDate.parse("2022-09-09"),12,"Divis",null),
						new MedicineModel("M02","paracetmol",56,LocalDate.parse("2021-03-22"),LocalDate.parse("2022-09-09"),12,"Divis",null)
