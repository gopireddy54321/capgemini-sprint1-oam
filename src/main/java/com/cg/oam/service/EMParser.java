...
public class EMParser {
	 ...
	 public Medicine parse(MedicineModel source) { 
		 return source==null?null:
			 new Medicine(source.getMedicineId(),
					...
					categoryRepo.findById(source.getCategoryId()).orElse(null));
	...
	public CategoryModel parse(Category source) {
		return source == null ? null : new CategoryModel(source.getCategoryId(),
				source.getCategoryName());
	}

	public Category parse(CategoryModel source) {
		return source == null ? null : new Category(source.getCategoryId(),
				source.getCategoryName());
	}
